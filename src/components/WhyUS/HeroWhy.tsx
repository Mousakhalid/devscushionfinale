             ...
             justify-center pt-12'>
                <div className='md:w-[50%] w-full'>
                    <h1 className='md:text-5xl text-3xl font-bold
                     text-gray-700'>Why DevsCushion</h1>
                    <p className='leading-7 text-lg font-medium pt-2'>
                        Trust DevsCushion for innovative development solutions that ensure reliability, boost efficiency, and foster business growth.
                    </p>
                    <div>
                        <CompanyButton />
                    </div>
