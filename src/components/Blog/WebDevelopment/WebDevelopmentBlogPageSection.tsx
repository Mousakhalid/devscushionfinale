import { webDevelopment } from '@/lib/interface';
...
async function getData(): Promise<webDevelopment[]> {
    const query = groq`*[_type == "webDevelopment"] {
    title, 
    overview,
    _createdAt,
    slug {
...
const WebDevelopmentBlogPageSection = async () => {
...
export default WebDevelopmentBlogPageSection;
