        ...
        <div className='bg-gray-100'>
            <div className='grid md:grid-cols-2 grid-cols-1 px-8 py-24 gap-8'>
                <div className='space-y-6'>
                    ...
                    <div>
                        <p className='text-gray-700 leading-loose tracking-wide' >As a full-service digital agency, DevsCushion empowers businesses by providing a complete range of FinTech services, from developing innovative platforms to executing targeted digital marketing strategies. Our expertise enables clients to improve operational efficiency, expand their reach, and drive substantial growth.</p>
                    </div>
                ...
                <div className='shadow-md'>
                    <Image src={'/fin.png'} alt='Fintech Expertise Devscushion' width={700} height={1000} className='w-full h-full ' />
                </div>
            </div>
        </div>
    )
...
export default FintechExpertise