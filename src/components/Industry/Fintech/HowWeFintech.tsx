            ...
            <div className='py-20'>
                <div>
                    <div className='text-center space-y-2'>
                        ...
                        <h1 className='md:text-3xl text-xl font-bold text-gray-50'>Optimized Step-by-Step Guide to Digital Finance Solutions <br />for the FinTech Industry</h1>
                    </div>
                </div>
