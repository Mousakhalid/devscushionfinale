            ...
            <div className='grid md:grid-cols-2 grid-cols-1 px-8 py-24 gap-8'>
                <div className='space-y-6'>
                    ...
                    <div>
                        ...
                        As a full-service digital agency, DevsCushion has transformed the entertainment industry by providing tailored digital services that enhance creativity, engagement, and operational efficiency. From immersive app development to strategic digital marketing, DevsCushion empowers brands to captivate and connect with their audiences like never before.
                        </p>
                    </div>
                ...
                <div className='shadow-md'>
                    <Image src={'/entertainmentimg.jpg'} alt='Fintech Expertise Devscushion' width={700} height={1000} className='w-full h-full ' />
                </div>
            </div>
        </div>
    )
...
export default EntertainmentExpertise