        ...
        <div className='md:px-16 px-6 bg-gray-100 border-b-gray-300 md:h-[500px] mb-12'>
            <div className='flex md:flex-row flex-col-reverse items-center justify-center pt-12 max-sm:pb-8'>
                <div className='md:w-[50%] w-full space-y-2'>
                    ...
                    <h1 className='md:text-5xl text-3xl font-bold text-gray-700'>Digital Marketing Services</h1>
                    <p className='leading-7 text-lg font-medium'>
                        Foster brand and love in your target audience—and drive growth—with digital marketing that hits home.
                    </p>
                    <div>
                        <Link href={'/contact'}>
                ...
                <div>
                    <Image src={'/digipng.png'} alt='bg-service devscushion' width={400} height={400} />
                </div>
            </div>
        </div>
    )
